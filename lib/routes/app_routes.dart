...
class AppRoutes {
  AppRoutes._();
  static const initial = notesList;
  static const carsList = "/CarsListView()";
  static const AddDeatils = "/AddDeatils_Item()";
  static const ProfileDetails = "/profile";
  static const sharedPref = "/shared";
  static const simpleList = "/simple_list";
  static const studentDetailsPage = "/student_details";
  static const notesList = "/notes_list";
  static const notesDetails = "/notes_details";
}
