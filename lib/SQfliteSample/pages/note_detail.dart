...
import 'package:axis_alignment/SQfliteSample/model/note.dart';
...
class NoteDetailState extends State<NoteDetail> {
  ...
  Widget build(BuildContext context) {
    // TextStyle textStyle = Theme.of(context).textTheme(healine)
  ...
  void updateTitle() {
    ...
    print("TITILE TITLE ${titleController.text}");
    print(note.title);
  }
