...
class StudentHelper {
  ...
  //   await db.insert(Student.TABLE, student.toMap());
  // }
  ...
  //   List<Student> students = objects?.isNotEmpty
  ...
  //   final db = await databaseHelper.database;
  //   await db.update(Student.TABLE, student.toMap(),
  //       where: '${Student.COL_ID} = ?', whereArgs: [student.id]);
  // }
